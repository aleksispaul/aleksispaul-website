...
showtoc: FALSE
---
I often end up trying to aggregate or merge student information across multiple google sheets to create simple charts/dashboards for attendance or grades. However, during the COVID-19 outbreak I've found my autodidactic approach to writing functions in Google Sheets has made it difficult to retain some of the functions in memory for future use. 
